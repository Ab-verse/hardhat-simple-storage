...
This is a simple Smart Contract written in Solidity programming language. The contract allows users to store and retrieve a favorite number, add people with their favorite numbers and names, and also map a name to its corresponding favorite number.
...
```
git clone https://github.com/Ab-verse/hardhat-simple-storage.git
